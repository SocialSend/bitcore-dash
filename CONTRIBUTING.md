# Contributing to socialsendcore

We're working hard to make *socialsendcore* the most powerful JavaScript library for working with SocialSend. Our goal is to have *socialsendcore* be a library that can be used by anyone interested in SocialSend, and to level expertise differences with great design and documentation.
...
These are some global design goals in socialsendcore to which any change should adhere.
...
```sh
git remote add socialsend git@github.com:SocialSend/socialsendcore.git
git pull --rebase socialsend master
```
...
```
Finally go to [github.com/SocialSend/socialsendcore](https://github.com/SocialSend/socialsendcore) in your web browser and issue a new pull request.
...
[github.com/SocialSend/socialsendcore/issues](https://github.com/SocialSend/socialsendcore/issues).
